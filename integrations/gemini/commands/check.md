...
You are starting the **Check** phase — comprehensive sequential verification.

> **Gemini CLI note**: Gemini CLI does not support parallel agent spawning. Reviewer, auditor,
> and test runner execute sequentially in the order below.
...
### Step 2: Run 3 sequential checks

**Check 1 — Reviewer** (use `agents/reviewer.md`):
...
**Check 2 — Auditor** (use `agents/auditor.md`):
