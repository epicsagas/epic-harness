...
1. Read GEMINI.md, README, package.json / pyproject.toml / go.mod
...
| **Fan-out/Fan-in** | Independent tasks reviewed together (review + test + lint) |
...
> **Gemini CLI note**: All agents run sequentially. Fan-out/Fan-in patterns execute each agent
> one after another rather than in parallel. Design accordingly.
