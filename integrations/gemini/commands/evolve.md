...
```
Observe (AfterModel — multi-dimensional scoring)
    ↓ .harness/obs/session_YYYYMMDD.jsonl
Analyze (AfterAgent or /evolve)
...
Reload (next session BeforeAgent reports metrics + loads evolved skills)
```
