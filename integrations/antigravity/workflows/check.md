...
### Step 2: Launch 3 agents via Manager View

**Open the Manager view** and launch these three agents in parallel:
...
All three run in parallel in Manager view. Wait for all three to complete before proceeding to synthesis.
...
- Running agents sequentially when Manager view enables parallel execution
