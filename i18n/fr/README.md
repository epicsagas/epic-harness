...
|------|-------------|------------------|--------|--------|
| **Claude Code** | ✓ Complet | ✓ 6 commandes | ✓ 8 compétences | ✓ 4 |
...
Lorsqu'enregistré comme serveur MCP (`harness mem mcp-install`), les agents peuvent appeler directement ces outils :
