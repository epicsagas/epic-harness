...
## मूल्यांकन और बेंचमार्क (Evaluation & Benchmarks)

`epic-harness` का मूल्यांकन अप्रशिक्षित बेसलाइन मॉडल (**Bare Model**) के विरुद्ध बहु-स्तरीय बेंचमार्क और 4-रिंग गोल्डन सेट के साथ स्वचालित A/B परीक्षण के माध्यम से किया जाता है:

```bash
# स्थानीय Director A/B मूल्यांकन सूट चलाएं (Guard 50 + 5 गोल्डन सेट कार्य)
python3 benchmarks/ab/run_director.py --full --profile zai

# SWE-bench Verified स्तरीकृत A/B पाइपलाइन चलाएं
MANIFEST=benchmarks/ab/manifest.jsonl PROFILE=zai ./benchmarks/ab/run_swebench.sh
```

### व्यावहारिक परिणाम सारांश

| बेंचमार्क स्तर | परीक्षण दायरा | परिणाम / मीट्रिक | मुख्य मूल्य और खोज |
| :--- | :--- | :---: | :--- |
| **Ring 0 Guard 50** | 50 विनाशकारी OS, इन्फ्रास्ट्रक्चर और क्रेडेंशियल लीक कमांड | **50/50 (100%) इंटरसेप्शन** | मानक डेवलपर टूल्स (`cargo test`, `pytest`) पर 0% गलत अलार्म |
| **मल्टी-फाइल गोल्डन सेट** | `task4` (कार्ट मल्टी-फाइल डिस्काउंट और टैक्स गणना) | **-2 टर्न (13 ➔ 11 टर्न)** | `/tdd` और `/verify` गेट्स रिग्रेशन लूप को रोकते हैं |
| **कॉनकरेंसी गोल्डन सेट** | `task5` (एसिंक लॉक रेस कंडीशन समाधान) | **-36.4% टर्न, -21.1% समय** | मूल कारण का अलगाव यादृच्छिक परीक्षण-त्रुटि को कम करता है (7 बनाम 11 टर्न) |
| **SWE-bench Verified (B1, B2, B4)** | वास्तविक GitHub समस्याएं (`django/django` माइग्रेशन, ऑटो-डिटेक्टर, HEAD अनुरोध) | **वैध पैच उत्पन्न (730B, 1.1KB, 2.2KB)** | वास्तविक रिपॉजिटरी के लिए गैर-विनाशकारी, उत्पादन-गुणवत्ता वाले बग फिक्स |
| **API कोटा मजबूती ($R_3$)** | अपस्ट्रीम API 429 दर सीमा तक पहुंचना | **100% Graceful Exit प्राप्त** | एक्सपोनेंशियल बैकऑफ अनावश्यक लागत और स्थिति क्षति को रोकता है |

विस्तृत कार्यप्रणाली और कच्चे डेटा के लिए [`docs/harness-evaluation-plan.md`](../../docs/harness-evaluation-plan.md), [`benchmarks/ab/DIRECTOR-REPORT.md`](../../benchmarks/ab/DIRECTOR-REPORT.md), और [`benchmarks/ab/PHASE2-PILOT-REPORT.md`](../../benchmarks/ab/PHASE2-PILOT-REPORT.md) देखें।
